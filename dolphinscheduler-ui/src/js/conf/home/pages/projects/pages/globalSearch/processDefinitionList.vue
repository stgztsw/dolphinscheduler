...
<script>
  ...
  export default {
    name: 'definition-global-list-index',
    data () {
      return {
        total: null,
        processListP: [],
    ...
    methods: {
      ...mapActions('dag', ['getGlobalProcessDefinition']),
      /**
       * File Upload
       */
      _uploading () {
    ...
    created () {
      ...
      if (!_.isEmpty(this.$route.params)) {
        ...
        this.processListP = _.assign(this.processListP, this.$route.params.processDefinitionList)
      }
    },
    mounted() {
      this.$modal.destroy()
