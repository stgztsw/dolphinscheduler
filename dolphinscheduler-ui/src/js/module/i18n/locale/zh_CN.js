...
export default {
  ...
  Rerun: '重跑',
  'Rerun Scheduler': '重跑调度',
  'Recovery Failed': '恢复失败',
  'Recovery Scheduler Failed': '恢复调度失败',
  Stop: '停止',
  Pause: '暂停',
  ...
  'initialized for recover': '任务恢复的初始化',
  'Recovery scheduler process': '恢复调度失败工作流',
  'Manual Scheduler': '手动调度',
  'Repeat Running Scheduler': '重跑调度',
  Executing: '正在执行',
  'Ready to pause': '准备暂停',
  'Ready to stop': '准备停止',
  ...
  'Stop by dependent failure': '依赖失败任务停止',
  Start: '运行',
  Copy: '复制节点',
  'Copy name': '复制名称',
  Delete: '删除',
