 ...
 */
package org.apache.dolphinscheduler.service.depend.email.utils;
...
public class Constants {
    ...
    public static final String TABLE = "<table border=\"1px\" cellpadding=\"5px\" cellspacing=\"-10px\">";

    public static final String TABLE_END = "</table>";

    public static final String CAPTION = "<caption>";

    public static final String CAPTION_END = "</caption>";

    public static final String HR = "<HR style=\"FILTER: alpha(opacity=100,finishopacity=0,style=2)\" width=\"100%\" color=#D6D5B7 SIZE=3>";
    ...
    public static final String BOBY_HTML_TAIL = "</body></html>";
